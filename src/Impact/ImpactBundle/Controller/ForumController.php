...
use ImpactBundle\Form\Type\ForumType;
use ImpactBundle\Form\Type\Remover\RemoveForumType;
...
class ForumController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('ImapctBundle:index.html.twig', array(
    ...
    public function removeForumAction(Request $request, Forum $forum)
    {
        ...
        return $this->render('@Impact/Admin/remove_forum.html.twig', array(
            'form' => $form->createView()
        ));
    }
}
