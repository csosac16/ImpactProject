...
abstract class BaseForum
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ImpactBundle\Entity\Category", inversedBy="forums")
     * @ORM\JoinColumn(name="category_id", referencedColumnName="id", nullable=false)
     */
    protected $category;
    
    /**
     * @ORM\OneToMany(targetEntity="ImpactBundle\Entity\Topic", mappedBy="forum", cascade={"persist", "remove"}))
     ...
     * Set category
     *
     * @param \ImpactBundle\Entity\Category $category
     *
     * @return Forum
     */
     ...
     * Get category
     *
     * @return \ImpactBundle\Entity\Category
     */
     ...
     * Add topic
     *
     * @param \ImpactBundle\Entity\Topic $topic
     *
     * @return Forum
     */
